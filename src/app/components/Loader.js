...
function Loader() {
  return (
    <div class="wrapper absolute w-screen h-screen top-0 left-0 bg-white flex items-center justify-center z-50">
        <div class="pokeball w-16 h-16 bg-white rounded-full relative overflow-hidden border-4 after:absolute border-gray-900 animate-spin
